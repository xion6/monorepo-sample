...
import {
  GetRankedProdoctsService,
} from './domain/services/GetRankedProdoctsService';
...
export function setupContainer(productsPort: GetProductsPort): TSyringeDependencyContainer {
  ...
  container.register<GetRankedProdoctsUseCase>("GetRankedProdoctsUseCase", { useClass: GetRankedProdoctsService });
